...
import { createArea, deleteArea, findAllAreas } from '@/services/areaService';
        ...
        <div className="min-h-screen bg-purple-50 p-4 md:p-8">
            <div className="max-w-6xl mx-auto">
                <div className="flex flex-col md:flex-row justify-between items-center align-middle mb-8">
                    <h1 className="text-2xl md:text-3xl font-bold text-purple-800 mb-4 md:mb-0">Áreas de Conhecimento</h1>
                    <button
                        type="button"
                ...
                <div className="bg-white rounded-lg shadow overflow-x-auto">
                    <table className="min-w-full table-auto">
                        <thead className="bg-purple-100">
                            <tr>
                                <th className="px-4 py-2 text-left text-purple-800">Nome da Área</th>
                                    ...
                                    <tr key={area.id} className="bg-white border-b hover:bg-gray-50">
                                        ...
                                        <td className="px-4 py-2">
                                            <div className="flex space-x-2 justify-end">
                                                ...
                                                <button onClick={() => handleDeleteArea(area.id)} className="text-purple-600 hover:text-orange-500 border border-gray-300 hover:border-orange-500 p-2 rounded-lg">
                ...
                <Modal.Body>
                    <form onSubmit={handleSubmitArea}>
                        <div className="space-y-6">
                            <h3 className="text-xl font-medium text-gray-900 dark:text-white">Nova Área</h3>
                            <div>
